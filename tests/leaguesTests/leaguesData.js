...
export const getLeaguesExpected = [
    {
      id: 271,
      active: true,
      type: 'domestic',
    ...
    },
    {
      ...
      is_cup: false,
      current_season_id: 18260,
      current_round_id: null,
      current_stage_id: 77453227,
...
export const getLeagueExpected = {
    id: 271,
    active: true,
    type: "domestic",
    legacy_id: 43,
...
export const getLeagueByNameExpected =  [
    {
        id: 501,
        active: true,
        type: "domestic",
